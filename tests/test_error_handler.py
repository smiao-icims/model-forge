...
class TestHandleErrors:
    ...
    def test_modelforge_error_passthrough(self) -> None:
    ...
    def test_timeout_error_with_request(self) -> None:
    ...
    def test_fallback_value_on_exception(self) -> None:
    ...
    def test_no_fallback_on_modelforge_error(self) -> None:
    ...
    def test_reraise_as_parameter(self) -> None:
    ...
    def test_logging_on_error(self, mock_logger: Any) -> None:
    ...
    @patch("modelforge.error_handler.logger")
    def test_logging_with_fallback(self, mock_logger: Any) -> None:
